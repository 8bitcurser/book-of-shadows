...
func StatusConditions(inv *models.Investigator) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 5, " title=\"IndefInsanity_Chk\" data-stat=\"IndefiniteInsane\" onclick=\"characterUtils.recalculateSheetValues(this, 'base'); CharacterSheet.updateStatusClasses(); this.blur()\"> <label class=\"form-check-label\" for=\"indef-insanity\" style=\"cursor: pointer;\">Indefinite Insanity</label></div><div class=\"form-check form-switch\"><input class=\"form-check-input editable\" type=\"checkbox\" role=\"switch\" id=\"major-wound\" style=\"cursor: pointer;\"")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		if inv.MajorWound {
		...
		templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 7, " title=\"MajorWound_Chk\" data-stat=\"MajorWound\" onclick=\"characterUtils.recalculateSheetValues(this, 'base'); CharacterSheet.updateStatusClasses(); this.blur()\"> <label class=\"form-check-label\" for=\"major-wound\" style=\"cursor: pointer;\">Major Wound</label></div><div class=\"form-check form-switch\"><input class=\"form-check-input editable\" type=\"checkbox\" role=\"switch\" id=\"unconscious\" style=\"cursor: pointer;\"")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		if inv.Unconscious {
		...
		templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 9, " title=\"Unconscious_Chk\" data-stat=\"Unconscious\" onclick=\"characterUtils.recalculateSheetValues(this, 'base'); CharacterSheet.updateStatusClasses(); this.blur()\"> <label class=\"form-check-label\" for=\"unconscious\" style=\"cursor: pointer;\">Unconscious</label></div><div class=\"form-check form-switch\"><input class=\"form-check-input editable\" type=\"checkbox\" role=\"switch\" id=\"dying\" style=\"cursor: pointer;\"")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		if inv.Dying {
		...
		templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 11, " title=\"Dying_Chk\" data-stat=\"Dying\" onclick=\"characterUtils.recalculateSheetValues(this, 'base'); CharacterSheet.updateStatusClasses(); this.blur()\"> <label class=\"form-check-label\" for=\"dying\" style=\"cursor: pointer;\">Dying</label></div></div></div></div>")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		return nil
